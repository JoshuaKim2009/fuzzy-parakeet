...
try:
    if(t==j):
        ...
        print(f'So close! You are so unlucky. Your guess was {t}. The REAL number was {j}. You have 1 more attempt.')
except:
...
try:
    if(g==l):
        ...
        print(f'Sorry! Your guess was {g}. The REAL number was {l}. You have run out of attempts.')
except:
