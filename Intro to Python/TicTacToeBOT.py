...
def pressurewasherBot(_paramDictMoveLocations,currentPlayerTurn):
    counter = 0
    while(counter!=1):
        try:
            coordinate=input(f'Player 1, which space would you like to play?')
            #check if space has already been played
            coordinate =_paramDictMoveLocations.get(coordinate)
            x=coordinate[0]
            y=coordinate[1]
            if(gameBoardpretty[x][y]== 'x'):
                print('You cannot play there')
            else:
                return coordinate
        except:
...
def THEBot(location, gameboard):
    if(gameboard[2][2]==' '):
        gameboard[2][2]=='o'
        return gameboard

def executeMoveBot(location, gameboard):
    x=location[0]
    y=location[1]
    gameboard[x][y]='x'
    return gameboard
...
humanOrBot=input('Do you want to play a bot or a human?')
while(humanOrBot!='bot' or humanOrBot!='human'):
    if(humanOrBot=='bot'):
        print('I am the bot you will face. You will never beat me!')
        turn=1
        winner=0
        while(winner!=1):
            turn+=1
            ...
            if(Turnthing==0):
                ...
                character='o'
            IntendedMoveSpot=pressurewasherBot(moveLocation,Turnthing) # Cleaned the Values
            print(f'Youre gonna move: {IntendedMoveSpot}')
            gameBoardpretty=executeMoveBot(IntendedMoveSpot, gameBoardpretty)
            THEBot(moveLocation, gameBoardpretty)
            for i in range(0,5):
                for k in range(0,5):
                    print(f'{gameBoardpretty[i][k]}',end='')
                print(' ')
    ...
    if(humanOrBot=='human'):
        ...
        while(winner!=1):
            ...
            if(gameBoardpretty[0][0] == 'x' and gameBoardpretty[0][2] == 'x' and gameBoardpretty [0][4] == 'x' or gameBoardpretty[0][0] == 'o' and gameBoardpretty[0][2] == 'o' and gameBoardpretty [0][4] == 'o' or gameBoardpretty[2][0] == 'x' and gameBoardpretty[2][2] == 'x' and gameBoardpretty [2][4] == 'x' or gameBoardpretty[2][0] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty [2][4] == 'o' or gameBoardpretty[4][0] == 'x' and gameBoardpretty[4][2] == 'x' and gameBoardpretty [4][4] == 'x' or gameBoardpretty[4][0] == 'o' and gameBoardpretty[4][2] == 'o' and gameBoardpretty [4][4] == 'o'):
                ...
                print(f'Player {Turnthing+1} is winner')
            #column win
            if(gameBoardpretty[0][0] == 'x' and gameBoardpretty[2][0] == 'x' and gameBoardpretty [4][0] == 'x' or gameBoardpretty[0][2] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty [4][2] == 'o' or gameBoardpretty[0][4] == 'x' and gameBoardpretty[2][4] == 'x' and gameBoardpretty [4][4] == 'x' or gameBoardpretty[0][2] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty [4][2] == 'o' or gameBoardpretty[0][2] == 'x' and gameBoardpretty[2][2] == 'x' and gameBoardpretty [4][2] == 'x' or gameBoardpretty[0][2] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty [4][2] == 'o'):
                winner=1
                print(f'Player {Turnthing+1} is winner')
            #diagonal win
            if(gameBoardpretty[0][0] == 'x' and gameBoardpretty[2][2] == 'x' and gameBoardpretty[4][4] == 'x' or gameBoardpretty[0][0] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty[4][4] == 'o' or gameBoardpretty[0][4] == 'x' and gameBoardpretty[2][2] == 'x' and gameBoardpretty[4][0] == 'x' or gameBoardpretty[0][4] == 'o' and gameBoardpretty[2][2] == 'o' and gameBoardpretty[4][0] == 'o'):
